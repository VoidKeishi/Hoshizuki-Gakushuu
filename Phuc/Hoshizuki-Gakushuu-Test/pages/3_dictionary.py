...
st.set_page_config(page_title="Search the word you need")
...
if "conversationsDictionary" not in st.session_state:
    st.session_state.conversationsDictionary = [{"role": "system", "content": content}]
...
if prompt := st.chat_input("What is up?"):
    st.session_state.conversationsDictionary.append({"role": "user", "content": prompt})
    ...
    st.session_state.conversationsDictionary.append({"role": "assistant", "content": full_response})