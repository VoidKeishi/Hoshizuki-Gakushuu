...
st.set_page_config(page_title="Japanese Quiz")
...
if "conversationsQuiz" not in st.session_state:
    st.session_state.conversationsQuiz = [{"role": "system", "content": content}]
...
if prompt := st.chat_input("What is up?"):
    st.session_state.conversationsQuiz.append({"role": "user", "content": prompt})
    ...
    st.session_state.conversationsQuiz.append({"role": "assistant", "content": full_response})